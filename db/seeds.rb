...
free_category = Category.create!(name: 'Free')
...
Event.create!([
      ...
      a few bugs!
                  ...
                  capacity: 3,
                  categories: [free_category, programming_category]
                },
                {
                  name: 'Hackathon',
                  location: 'Austin, TX',
      ...
      and prizes for winners in a variety of categories.
                ...
                },
                {
                  ...
                  description: %(
      Kata Camp is where developers go to practice
      their craft without interruptions.
      Skip the status reports and stand-up meetings of a typical project.
      Just get 'er done!
      Price includes a buffet lunch and a leather-bound journal to record your kata achievements.
                ...
                },
                {
                  ...
                  description: %(
      Start your day off right with a good cup of Joe
      while you sling some code with other local developers.
      By the time you hit the office, you'll be in the groove!
                ...
                },
                {
                  ...
                  description: %(
      Come enjoy a technical talk and meet local Rails developers!
      This week's topic is a comparison of editors, templating systems,
      and whether to use tabs or spaces.
    ).squish,
                  capacity: 3,
                  categories: [free_category, rails_category, programming_category]
                },
                {
      ...
      a new Ruby-related topic to help you keep on top of your game.
                  ...
                  capacity: 3,
                  categories: [free_category, ruby_category, programming_category]
                },
                {
                  ...
                  description: %(
      Got a newfangled trick? A handy new tool?
      A just-released library? Here's your chance to share it!
      But you only get 5 minutes to present your must-know tip, so keep it snappy.
      Price includes an open ice cream and root beer float bar.
    ).squish,
                  capacity: 3,
                  categories: [programming_category]
                },
      ...
      Thing spin, whirl, and (possibly) collide! Everyone is welcome,
      whether you're new to hacking with drones and drone software,
      or have experience that reaches to the sky.
    }.squish,
                  capacity: 3,
                  categories: [free_category, programming_category]
                },
                {
                  ...
                  description: %(
      Why ninjas? We have no idea, but the icon is cool.
      Don't miss this opportunity to show off your ninja moves.
    ).squish,
                  capacity: 3,
                  categories: [programming_category]
                }
...
[
  ...
  f = Rails.root.join("app/assets/images/#{file_name}").open
...
User.create([
              ...
              {
                name: 'Marlena',
                email: 'marlena@example.com',
                password: 'password12'
              },
              {
                name: 'Tosia',
                email: 'tosia@example.com',
                password: 'password12'
              }
            ])
...
User.all.each do |user|
  events.sample(4).each do |event|
    Like.create!(user:, event:)
  end
end
